...
export const translations = {
  ...
  en: {
    ...
    insights: {
      ...
      dialogTitle: 'AI Portfolio Analysis',
      dialogDesc: 'Structured analysis based on your aggregated holdings',
      disclaimer: 'Generated by AI for reference only — not financial advice.',
      analyzing: 'Analyzing...',
